...
const EditServiceFeature = () => {
  ...
  function EditService(e) {
    ...
    axios
      .put(`${baseURL}/servicefeature/updatefeature/${idss}`, data, options)
      .then((response) => {
  ...
  useEffect(async () => {
    ...
    const data = await axios.get(`${baseURL}/servicefeature/getfeature/${idss}`, options);

    const services = data.data.data;
    setNames(services[0]?.name);
...
export default EditServiceFeature;
